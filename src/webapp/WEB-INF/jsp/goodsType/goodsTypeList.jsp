                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <td>${v.typename}</td>
                               <td>
                            <a class="btn btn-small btn-primary" href="<%=request.getServletContext().getContextPath()%>/admin/goodsType/toUpdateGoodsType/${v.id}" >修改</a>
                            <a class="btn btn-small btn-warning" href="" onclick="toDelete(this)" uri="<%=request.getServletContext().getContextPath()%>/admin/goodsType/deleteType/${v.id}">删除</a>
                            </td>
                            </tr>
                            </c:forEach>
                            </tbody>
