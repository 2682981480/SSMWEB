                    ...
                    <div class="ibox-content">
                        <form action="<%=request.getServletContext().getContextPath() %>/admin/adminEditSave"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="id" class="form-control" readonly="readonly" value="${v.id }">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="fakename" class="form-control" value="${v.fakename }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" class="form-control" name="password" value="${v.password }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <c:when test="${v.sex == '男' }">
                                    ...
                                    <div class="radio i-checks">
                                        <label>
                                            <input type="radio" name="sex" checked="checked" value="女" > <i></i> 女</label>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="telephone" class="form-control" value="${v.telephone }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="email" class="form-control" value="${v.email }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
