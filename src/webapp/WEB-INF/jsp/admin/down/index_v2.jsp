...
<head>
    ...
    <!-- Morris -->
    <link href="<%=request.getServletContext().getContextPath() %>/static/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<body class="gray-bg sidebar-content">
        ...
        <div>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="<%=request.getServletContext().getContextPath() %>/static/img/a1.jpg">
                </a>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="<%=request.getServletContext().getContextPath() %>/static/img/a2.jpg">
                </a>
                <div class="media-body">
                    V信已经提前恢复，也算是个好消息吧
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="<%=request.getServletContext().getContextPath() %>/static/img/a3.jpg">
                </a>
                <div class="media-body">
                    是你对不对
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="<%=request.getServletContext().getContextPath() %>/static/img/a4.jpg">
                </a>
                <div class="media-body">
                    发布了一篇文章
                    <br>
    ...
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/flot/curvedLines.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/demo/peity-demo.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/content.min.js?v=1.0.0"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="<%=request.getServletContext().getContextPath() %>/static/js/demo/sparkline-demo.min.js"></script>
    <script>
